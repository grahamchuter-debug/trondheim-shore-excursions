...
export function ContentPage({
  ...
  breadcrumbs,
  belowHero,
  ctaTitle = "Explore Trondheim excursion options",
  ctaText = "Browse cathedral, riverfront and walking ideas shaped around a day in port, with enough margin to return before all aboard.",
  ctaHref = siteConfig.shoreExcursionsPath,
  ctaButtonLabel = "Explore Trondheim excursions",
